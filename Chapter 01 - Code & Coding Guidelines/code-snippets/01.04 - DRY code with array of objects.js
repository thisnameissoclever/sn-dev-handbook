/**
 * DRY code using an array of objects - BETTER
 * 
 * Instead of repeating the entire code block, we construct an array
 * of objects containing the differing data, then loop through it.
 * 
